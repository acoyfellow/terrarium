...
function renderTable() {
  ...
  return `<main class="shell"><header class="top"><a class="brand" href="/"><span class="mark"></span>TERRARIUM</a><time class="status">${runStamp()}</time></header>
    <section class="sheet-head"><div><div class="eyebrow">SECURITY HARDENING RUN LOG</div><h1>Runs, instructions, environment, result.</h1><p>No story layer. No generated turn art. This table records what the agents were asked to probe, the environment they ran against, what changed, and where to inspect the evidence.</p></div><div class="sheet-counts"><b>${turns.length}</b><span>recorded turns</span><b>${evidenceBacked}</b><span>evidence-backed</span></div></section>
